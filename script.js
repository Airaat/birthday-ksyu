/* ===========================================================
   КОНФИГ — РЕДАКТИРУЙ ЭТОТ БЛОК, ОСТАЛЬНОЕ МОЖНО НЕ ТРОГАТЬ
   =========================================================== */
const CONFIG = {
  // Имя девушки (выводится на boot screen и в шапке)
  girlfriendName: "КСЮША",

  // Причины, почему она лучшая (можно сколько угодно штук)
  reasons: [
    "Причина №1 — напиши здесь, за что ты её любишь",
    "Причина №2 — например, как она поддерживает тебя",
    "Причина №3 — её смех / привычка / шутки",
    "Причина №4 — что-то, что только вы двое понимаете",
    "Причина №5 — как она заботится о тебе",
    "Причина №6 — её упорство или талант",
    "Причина №7 — момент, который ты не забудешь",
    "Причина №8 — то, что заставляет тебя улыбаться",
    "Причина №9 — её доброта к другим",
    "Причина №10 — просто потому что это она"
  ],
