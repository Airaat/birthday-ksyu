...
const CONFIG = {
  ...
  reasons: [
    ...
    "У тебя шикарный вкус, который проявляется во всём: от музыки и фильмов, до твоих повседневных нарядов",
  ...
  relationshipStartDate: "2025-06-15",

  // Главное поздравление на финальном экране
  finalMessage: `
    С днём рождения, милая!
    Пусть сбудутся все твои мечты, жизнь будет полна на яркие события и путешествия!
    Будь счастлива и любима <3
  `,
